...
import { EducationComponent } from "./local-component/content/education/education.component";
...
export const router: Route[] = [
  ...
  {path:'rifqi/profile', component: ProfileComponent},
  {path:'rifqi/education', component: EducationComponent},
